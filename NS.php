...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Networking Skills</h3></center></hr>
				<hr><p>In today's rapidally changing world every business/company/individual must need a privite network so that he must reduce his cost of managing and storing data,a network engineer plays a very important role in this by developing new network or managing and administrating the already existing network,I learn the following things as a network engineer which given below:</p>
				<ol>
					<li>Windows Server 2012 installation and configuration.</li>
					<li>TCP/IP configuration.</li>
					<li>Basic Knowledge of CCNA.</li>
				</ol>
		</hr>
