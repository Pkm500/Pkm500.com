...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
		...
		<div class="ECA">
			...
			<hr><p>
				Extra Curricular Activities is beneficial for everyone growth, Whenever I get chance i must participate in extracullicular activities.some of them are mentioned below:

			</p>
				<ul><em>
					<li>participate in Yoga Day held in Jetking, Vikaspuri.</li>
					<li>participate in clean india mission of Mr. Narendra Modi</li>
				</em></ul>
			</hr>
