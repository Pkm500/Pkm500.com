...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Marketing Internship</h3></center></hr>
				<hr><p>I done 2 months internship as <strong>Social Media Marketing Person</strong> in <strong>Oligo Sports and Fitness Pvt. Ltd.</strong>. which is a startup,where i done the following work: </p>
				<ol>
					<li>Promote the company on social sites.</li>
					<li>Promotes company products and services on social sites.</li>
					<li>Cordinate the team which is leaded by me.</li>
				</ol>
		</hr>
