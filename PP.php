...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Programming Projects</h3></center></hr>
				<hr><p>I made many Programming Projects, but the main projects are given below:</p>
				<ol>
					<li>Develop tic-tac-toe game using c/c++.</li>
					<li>Develop Jumble Word Game using Core Java.</li>
				</ol>
		</hr>
