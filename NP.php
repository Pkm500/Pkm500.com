...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Networking Projects</h3></center></hr>
				<hr><p>I made many Networking Projects, but the main projects are given below:</p>
				<ol>
					<li>Minor Project is Conjunction Control in Computer Network.</li>
					<li>Develop Windows Deployment Server.</li>
				</ol>
		</hr>
