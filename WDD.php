<html>
	<head>
		<title>
			Web Designing and Developing Skills
		</title>
		<style>		
.menu ul
{
...
.menu ul ul li:hover ul
{
	display:block;
			...
			body{
				//background:url('Images/wds.jpg') no-repeat;
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Web Designing and Developing Skills</h3></center></hr>
				<hr><p>In today's rapidally changing world every business/company/individual must need a website so that he must cover a large area at the same time,I learn the following web development technology as given below to face the rapidaly changing world:</p>
				<ol>
					<li>HTML</li>
					<li>CSS</li>
					<li>JavaScript</li>
