...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
		...
		<div class="career">
			...
			<hr><p>
				The main objective of my career is to obtain a challenging position that will give me an opportunity to utilize my professional caliber for the benefit of the organization. I can use best of my knowledge to achieve organizational as well as my personal goal.
			</p></hr>
