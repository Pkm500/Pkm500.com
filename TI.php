...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Technical Internship</h3></center></hr>
				<hr><p>I done 2 technical internships as given in the following details:</p>
				<ol>
					<li>Two month internship in jetking, vikaspuri as technical trainer/faculty of computer network.</li>
					<li>Six months internship in broadvision technology as webdesigner and developer.</li>
				</ol>
		</hr>
