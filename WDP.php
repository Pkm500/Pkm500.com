...
.menu ul ul li:hover ul
{
	...
	<div class="menu">
			<ul>
				...
				<hr><center><h3>Web Designing Projects</h3></center></hr>
				<hr><p>I made many Web Designing Projects, but the main projects are given below:</p>
				<ol>
					<li>Design an online shopping website using HTML,CSS and JavaScript.</li>
					<li>Design an online shopping website using HTML,CSS,PHP and JavaScript.</li>
				</ol></hr>
